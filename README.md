# Artifact Cruncher
Parse forensic disk triage collection on Windows. Zip to Plaso and CSV. Uses WSL and Docker. Maintains compatibility with Windows filesystem. Optional output ingest into local Docker Splunk instance. Tested on: Windows 11, WSL2, Ubuntu 22.04 guest, Docker.
