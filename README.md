...
## Installation
From the `Windows` filesystem navigate to the desired install location. Launch `Ubuntu 22.04` terminal via `WSL2`. Run one of the following code snippets as `root`.
