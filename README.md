# Artifact Cruncher
Parse Velociraptor triage collection to Supertimeline on Windows. Environment built using WLS2 and Docker. Optional ingest into local Splunk container. Tested on: Windows 11, WSL2, Ubuntu 22.04 guest, Docker.  
